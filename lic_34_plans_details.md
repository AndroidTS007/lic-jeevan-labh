# Technical Specifications: LIC 34 Plans & Riders Catalog

This document catalogs complete specification details for **34 LIC products** (consisting of 27 flagship plans and 7 supplemental riders) configured in the system.

---

## Part 1: Flagship Insurance Plans (27 Plans)
...
### 8. LIC's Nav Jeevan Shree
*   **ID:** `nav_jeevan_shree`
*   **Plan Number:** 912
*   **UIN:** 512N387V02
*   **Category:** Endowment
*   **Min Entry Age:** 90 days
*   **Max Entry Age:** PPT dependent
*   **Min Sum Assured:** ₹2,00,000
*   **Max Sum Assured:** No upper limit
*   **Features:**
...
### 9. LIC's Bima Lakshmi
*   **ID:** `bima_lakshmi`
*   **Plan Number:** 881
*   **UIN:** 512N389V01
*   **Category:** Endowment
*   **Min Entry Age:** Minor (guardian)
*   **Max Entry Age:** Adult women
*   **Min Sum Assured:** ₹2,00,000
*   **Max Sum Assured:** No upper limit
*   **Features:**
...
### 10. LIC's New Jeevan Sathi – Single Premium
*   **ID:** `jeevan_sathi_single`
*   **Plan Number:** 888
*   **UIN:** 512N393V01
*   **Category:** Endowment
*   **Min Entry Age:** 18 years (both)
*   **Max Entry Age:** Depends on term
*   **Min Sum Assured:** ₹2,00,000
*   **Max Sum Assured:** No upper limit
*   **Features:**
...
### 11. LIC's New Jeevan Sathi – Limited Premium
...
### 12. LIC's Jeevan Umang
*   **ID:** `jeevan_umang`
*   **Plan Number:** 745
*   **UIN:** 512N312V03
*   **Category:** Whole Life
*   **Min Entry Age:** 90 days
*   **Max Entry Age:** 55 years (PPT 15)
*   **Min Sum Assured:** ₹2,00,000
*   **Max Sum Assured:** No upper limit
*   **Features:**
...
### 14. LIC's Jeevan Utsav – Single Premium
...
### 16. LIC's New Money Back Plan – 20 Years
*   **ID:** `money_back_20`
*   **Plan Number:** 720
*   **UIN:** 512N280V03
*   **Category:** Money Back
...
### 17. LIC's New Money Back Plan – 25 Years
*   **ID:** `money_back_25`
*   **Plan Number:** 721
*   **UIN:** 512N278V03
*   **Category:** Money Back
...
### 18. LIC's New Children's Money Back Plan
*   **ID:** `children_money_back`
*   **Plan Number:** 732
*   **UIN:** 512N296V03
*   **Category:** Money Back
*   **Min Entry Age:** 0 years (90 days)
...
*   **Max Entry Age:** 65 years
*   **Min Sum Assured:** ₹2,00,000
*   **Max Sum Assured:** Aligned to loan amount
*   **Features:**
...
*   **Max Entry Age:** 45 years
*   **Min Sum Assured:** ₹2,00,000
*   **Max Sum Assured:** Aligned to loan
*   **Features:**
...
## Part 2: Supplemental Insurance Riders (7 Riders)

### 28. LIC's Accident Benefit Rider
*   **ID:** `accident_benefit`
*   **UIN:** 512B203V03
*   **Category:** Supplemental Rider
*   **Min Entry Age:** 18 years
*   **Max Entry Age:** 70 years
*   **Min Sum Assured:** Depends on base policy
*   **Max Sum Assured:** Aligned to base policy Sum Assured
*   **Features:**
    *   Provides additional lump sum sum assured if death occurs specifically due to an accident
    *   Rider Sum Assured paid in addition to the base policy's standard death benefit

### 29. LIC's Premium Waiver Benefit Rider
*   **ID:** `premium_waiver`
*   **UIN:** 512B204V04
*   **Category:** Supplemental Rider
*   **Min Entry Age:** 18 years
*   **Max Entry Age:** 55 years
*   **Min Sum Assured:** Equal to future base premium load
*   **Max Sum Assured:** Equal to future base premium load
*   **Features:**
    *   Waives all future base policy premiums if the proposer/parent becomes permanently disabled or dies
    *   Crucial for child protection plans (Jeevan Tarun, Children Money Back)

### 30. LIC's Accidental Death & Disability Benefit Rider
*   **ID:** `accidental_death_disability`
*   **UIN:** 512B209V02
*   **Category:** Supplemental Rider
*   **Min Entry Age:** 18 years
*   **Max Entry Age:** 65 years (covers up to age 70)
*   **Min Sum Assured:** Depends on base policy
*   **Max Sum Assured:** ₹1,00,00,000 (1 Crore)
*   **Features:**
    *   Pays extra sum on accidental death AND covers total permanent disability from accidents
    *   Disability payouts paid as equal monthly instalments over 10 years + future premiums waived

### 31. LIC's New Term Assurance Rider
*   **ID:** `new_term_assurance`
*   **UIN:** 512B210V02
*   **Category:** Supplemental Rider
*   **Min Entry Age:** 18 years
*   **Max Entry Age:** Aligned to base policy maturity
*   **Min Sum Assured:** Depends on base policy
*   **Max Sum Assured:** Aligned to base policy Sum Assured
*   **Features:**
    *   Adds a layer of pure protection term cover on top of the base plan's standard death benefit
    *   Nominee receives both base Sum Assured and Rider Sum Assured on death, doubling protection

### 32. LIC's Linked Accidental Death Benefit Rider
*   **ID:** `linked_accidental_death`
*   **UIN:** 512A211V02
*   **Category:** Supplemental Rider
*   **Min Entry Age:** Aligned to base ULIP
*   **Max Entry Age:** Aligned to base ULIP
*   **Min Sum Assured:** Depends on base ULIP
*   **Max Sum Assured:** Aligned to base ULIP Sum Assured
*   **Features:**
    *   Adds accidental death protection exclusively to Unit Linked Insurance Plans (ULIPs)
    *   Rider Sum Assured paid in addition to the ULIP fund value on accidental death

### 33. LIC's Critical Illness Health Rider
*   **ID:** `critical_illness_health`
*   **UIN:** 512B227V01
*   **Category:** Supplemental Rider
*   **Min Entry Age:** 18 years
*   **Max Entry Age:** 65 years (terminates at age 75)
*   **Min Sum Assured:** Depends on base policy
*   **Max Sum Assured:** Aligned to base policy Sum Assured
*   **Features:**
    *   Pays a lump sum upon first diagnosis of any of the covered 15 major critical illnesses
    *   Diagnosis-based lump sum payout; reduces the base sum assured proportionally, policy continues

### 34. LIC's Female Critical Illness Benefit Rider
*   **ID:** `female_critical_illness`
*   **UIN:** 512B226V01
*   **Category:** Supplemental Rider
*   **Min Entry Age:** 18 years (female lives only)
*   **Max Entry Age:** 65 years
*   **Min Sum Assured:** Depends on base policy
*   **Max Sum Assured:** Aligned to base policy Sum Assured
*   **Features:**
    *   Specialized critical illness rider exclusively for female policyholders, covering women-specific risks
    *   Lump sum paid on first diagnosis of covered female-specific conditions (breast, ovarian, cervical cancer, etc.)
